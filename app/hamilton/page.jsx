...
export default function CityPage(){
  const images = [1,2,3,4,5,6].map(i => `/cities/hamilton/${i}.jpg`);
  return (
    <div className="container-x py-10">
      <nav className="text-sm text-gray-500 mb-6"><Link href="/">Home</Link> / Hamilton</nav>
      <h1 className="text-3xl font-bold">Hamilton — Wallpaper Removal & Painting</h1>
      <p className="mt-2 text-gray-700">Local photos, process, pricing guidance, and covered neighborhoods in Hamilton.</p>
      ...
      <section className="prose-custom mt-10">
        <h2>Why homeowners in Hamilton choose us</h2>
        <ul>
